...
<h2 className='text-primary text-2xl font-bold my-3'>Interpretation and Definitions</h2>
<h3 className='text-secondary text-lg font-bold my-1'>Interpretation</h3>
<p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
<h3 className='text-secondary text-lg font-bold my-1'>Definitions</h3>
<p>For the purposes of this Cookies Policy:</p>
<ul>
<li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to AI Agency Directory.</li>
<li><strong>Cookies</strong> means small files that are placed on Your computer, mobile device or any other device by a website, containing details of your browsing history on that website among its many uses.</li>
<li><strong>Website</strong> refers to AI Agency Directory, accessible from <a href="aiagencydirectory.com" rel="external nofollow noopener" target="_blank">aiagencydirectory.com</a></li>
<li><strong>You</strong> means the individual accessing or using the Website, or a company, or any legal entity on behalf of which such individual is accessing or using the Website, as applicable.</li>
</ul>
<h2 className='text-primary text-2xl font-bold my-3'>The use of the Cookies</h2>
<h3 className='text-secondary text-lg font-bold my-1'>Type of Cookies We Use</h3>
...
<h3 className='text-secondary text-lg font-bold my-1'>Your Choices Regarding Cookies</h3>
