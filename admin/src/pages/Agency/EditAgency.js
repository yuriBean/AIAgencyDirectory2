...
import { getAgencyById, editAgency, getIndustries, getServices } from '../../services/firestoreService';
...
const EditAgency = () => {
  ...
  return (
    <>
    <PageHead name = 'Edit Agency Profile' />
...
<div className='flex justify-between gap-3'>
        ...
        <div>
          <label htmlFor="isApproved" className="block font-bold mb-2">Is Approved</label>
          <input
            type="checkbox"
            id="isApproved"
            name="isApproved"
